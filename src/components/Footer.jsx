...
const Footer = () => {
    ...
    return ( 
        <div className={`flex flex-col items-center h-[600px] pt-[140px] pb-[100px] pl-[235px] pr-[62px] w-full ${dark? 'bg-bg' : 'bg-text_main'}`}>
            <div>
            ...
            <div className={`flex justify-center w-[386px] h-[60px] p-[3px] mt-[32px] mb-[42px] rounded-full ${dark? 'bg-text_main' : 'bg-card'}`}>
                <form className="flex justify-between h-[36px] rounded-full bg-transparent" action="">
                    <input 
                    className={`text-center w-[308px] h-full rounded-full focus:outline-none border-none  bg-transparent placeholder:text-inactive ${dark? 'text-card' : 'text-text_main'}`}
                    type="text" 
            ...
            <div className="flex justify-between w-full text-[14px] font-light text-inactive mt-[80px] mb-[140px] px-[30px]">
